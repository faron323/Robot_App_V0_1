...
var app = {
    ...
    bindEvents: function() {
        ...
        plusButton.addEventListener('click', this.sendPlus, false);
        negativeButton.addEventListener('click', this.sendMinus, false);
    },
    ...
    connect: function(e) {
        var deviceId = e.target.dataset.deviceId,
            onConnect = function(peripheral) {
                ...
                plusButton.dataset.deviceId = deviceId;
                negativeButton.dataset.deviceId = deviceId;
    ...
    sendPlus: function(event) { // send data to Arduino

        var success = function() {
            console.log("success");
            resultDiv.innerHTML = resultDiv.innerHTML + "Sent: " + "on" + "<br/>";
            resultDiv.scrollTop = resultDiv.scrollHeight;
        };
    ...
    sendMinus: function(event) { // send data to Arduino

        var success = function() {
            console.log("success");
            resultDiv.innerHTML = resultDiv.innerHTML + "Sent: " + "off" + "<br/>";
            resultDiv.scrollTop = resultDiv.scrollHeight;
        };
